...
async function loadChart() {
	...
	Plotly.newPlot('temp_rpm_chart', [temp, rpm], {yaxis: {title: 'CPU, m˚C', gridcolor: 'rgba(99, 110, 250, 0.2)'},  yaxis2: {title: 'Fan RPM', overlaying: 'y',  side: 'right', gridcolor: 'rgba(239, 85, 59, 0.2)'}, template: template});
